...
@section('content')
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Arsip</div>
        <div class="ps-3">
            <span>Surat</span>
        </div>
        <div class="ms-auto">
                ...
                <table id="example2" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        @foreach ($data_arsip as $item)
                            ...
                            @else
                                @php $file = substr($item->file, 23) @endphp
                            @endif
                            <tr>
                                ...
                                <td>
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                        <a href="javascript:;" class="text-warning" data-bs-toggle="tooltip"
                                            ...
                                            data-instansi="{{ $item->instansi }}" data-file="{{ $item->file }}"
                                            data-jenis_surat="{{ $item->jenis_surat }}" data-bs-placement="bottom"
...
@section('script')
    ...
    <script src="{{ asset('js/modal-show-arsip.js') }}"></script>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        setTimeout(function() {
                            ...
                            location.replace("{{ route('arsip.index') }}")
                        }, 2200);
                    },
                    error: function(data) {
                        console.log('Error:', data);
