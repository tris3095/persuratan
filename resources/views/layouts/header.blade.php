                ...
                <li class="nav-item dropdown dropdown-user-setting">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                        <div class="user-setting d-flex align-items-center">
                            <img src="{{ asset('img/person.png') }}" class="user-img" alt="">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('user.profil') }}">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('img/person.png') }}" alt="" class="rounded-circle" width="54"
                                        height="54">
                                    <div class="ms-3">
                                        <h6 class="mb-0 dropdown-user-name">
                                            {{ Str::of(Auth::user()->nama)->limit(21) }}</h6>
                                        <small
                                            class="mb-0 dropdown-user-designation text-secondary">{{ Str::of(Auth::user()->getJabatan->nama_singkat)->limit(21) }}
                                        </small>
                                    </div>
                                </div>
                            </a>
